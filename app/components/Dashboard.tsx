    ...
    <main className="min-h-screen">
      ...
      <header className="px-10 pt-10 pb-6 border-b" style={{ borderColor: 'var(--rule)' }}>
        <div className="flex items-center justify-between mb-3">
          <div className="eyebrow">Operations · {new Date().toLocaleDateString('en-IN', { day: '2-digit', month: 'long', year: 'numeric' })}</div>
          <div className="eyebrow" style={{ color: 'var(--warm)' }}>Closed Loop · v1</div>
        </div>
